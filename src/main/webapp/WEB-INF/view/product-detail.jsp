                                    ...
                                    <div id="demo-1" class="simpleLens-gallery-container">
                                        <div class="simpleLens-container">
                                            <div class="simpleLens-big-image-container">
                                                <a data-lens-image="/images/product/${product.productId}/0.png" class="simpleLens-lens-image">
                                                    <img src="/images/product/${product.productId}/0.png" class="simpleLens-big-image" >
                                                </a>
                                            </div>
                                        </div><!--  
                                ...
                                <li>
                                    <figure>
                                        <a class="aa-product-img" href="/pd/p?id=${product.productId}">
                                            <img style="width: 250px; height: 300px" src="/images/product/${product.productId}/0.png" ></a>
