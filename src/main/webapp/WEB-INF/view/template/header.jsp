                    ...
                    <div class="aa-header-bottom-area">
                        ...
                        <div class="aa-logo">
                            ...
                            <a href="/">
                                ...
                                <p>Music<strong>Store</strong> <span>Bring music to life</span></p>
                            </a>
                        </div>
                        <!-- / logo  -->
                        <!-- cart box -->
                                ...
                                <div class="aa-cartbox-summary">
                                    <ul>
                                        <li ng-repeat="item in cart.cartItems">
                                            <a class="aa-cartbox-img"><img src="/images/product/{{item.product.productId}}/0.png" alt="img"></a>
            ...
            <div class="navbar navbar-default" role="navigation">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="/">Home</a></li>
                        <li><a href="/pd/s?mc=guitars">Guitars <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="/pd/s?mc=guitars&sc=electric-guitars">Electric Guitars</a></li>
                                <li><a href="/pd/s?mc=guitars&sc=acoustic-guitars">Acoustic Guitars</a>
                                  <ul class="dropdown-menu">
                                     <li><a href="#">6-String</a></li>
                                     <li><a href="#">12-String</a></li>
                                  </ul>
                                </li>
                                <li><a href="/pd/s?mc=guitars&sc=folk-guitars">Folk Guitars</a></li>
                            </ul>
                        </li>
                        <li><a href="<spring:url value="/pd/s?mc=drums"/>">Drums <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="/pd/s?mc=drums&sc=acoustic-drums">Acoustic Drums</a></li>
                                <li><a href="/pd/s?mc=drums&sc=electric-drums">Electric Drums</a></li>
                            </ul>
                        </li>
                        <li><a href="/pd/s?mc=microphones">Microphones</a></li>
                        <li><a href="/pd/s?mc=pianos">Pianos</a></li>
                        <li><a href="/pd/s">All Products</a></li>
